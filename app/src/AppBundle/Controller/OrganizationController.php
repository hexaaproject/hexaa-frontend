...
class OrganizationController extends Controller {
    ...
    public function indexAction() {
        ...
        return $this->render(
                        'AppBundle:Organization:index.html.twig', array(
    ...
    public function showAction($id) {
        ...
        return $this->render(
                        'AppBundle:Organization:show.html.twig', array(
    ...
    public function propertiesAction($id) {
        ...
        return $this->render(
                        'AppBundle:Organization:properties.html.twig', array(
                    "organizations" => $this->getOrganizations(),
                    "services" => $this->getServices(),
                    "organization" => $organization,
                    "roles" => $roles,
    ...
    public function usersAction($id) {
        ...
        return $this->render(
                        'AppBundle:Organization:users.html.twig', array(
                    "managers" => $managers,
                    "members" => $members,
                    "organization" => $organization,
                    "organizations" => $this->getOrganizations(),
    ...
    public function rolesAction($id) {
        ...
        return $this->render(
                        'AppBundle:Organization:roles.html.twig', array(
                    "organization" => $organization,
                    "organizations" => $this->getOrganizations(),
                    "roles" => $roles,
                    "services" => $this->getServices(),
    ...
    public function connectedservicesAction($id) {
        return $this->render(
                        'AppBundle:Organization:connectedservices.html.twig', array(
                    "organization" => $this->getOrganization($id),
                    "organizations" => $this->getOrganizations(),
                    "services" => $this->getServices(),
                    'orgsubmenubox' => $this->getorgsubmenupoints()
