...
$config = array(
    ...
    'technicalcontact_email' => 'aai@sztaki.hu',
     ...
     */
    'sendmail_from' => 'no-reply@dev.hexaa.eu',
    ...
    'authproc.aa' => array(
        60 => array(
            ...
            'hexaa_api_url' =>          'https://dev.hexaa.eu/backend/app.php/api',
            'hexaa_master_secret' =>    'hexaa_master_secret'
        ),
    ),
    ...
    'metadata.sources' => array(
        ...
        array(
         ...
         'cachedir' => '/tmp', //opcionális, de ajánlott
