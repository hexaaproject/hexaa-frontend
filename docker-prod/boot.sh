...
HEXAA_FRONTEND_MAILER_PORT=${HEXAA_FRONTEND_MAILER_PORT:-"25"}
HEXAA_FRONTEND_MAILER_USER=${HEXAA_FRONTEND_MAILER_USER:-"null"}
HEXAA_FRONTEND_MAILER_PASSWORD=${HEXAA_FRONTEND_MAILER_PASSWORD:-"null"}
